...
const FEATURES = [
  {
    icon: "📊",
    title: "Volle Statistik",
    description: "Komplette Wochenübersicht deiner Rauchgewohnheiten",
  },
  {
    icon: "📅",
    title: "Zukünftige Tage",
    description: "Plane deinen Zigarettenplan für kommende Tage",
  },
  {
    icon: "🎯",
    title: "Alle Einstellungen",
    description: "Hintergrundfarbe und alle App-Einstellungen",
  },
];
